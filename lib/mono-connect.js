...
const MonoConnect = (props) => {
  const { publicKey, onClose, onSuccess, onEvent, openWidget } = props,
    otherConfig = __rest(props, [
      'publicKey',
      'onClose',
      'onSuccess',
      'onEvent',
    ...
    const qs = Object.assign(
      {
        ...
        scope:
          otherConfig === null || otherConfig === void 0
            ? void 0
            : otherConfig.scope,
        data:
          otherConfig === null || otherConfig === void 0
